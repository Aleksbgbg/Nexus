...
export const websites: Website[] = [
  ...
  new WebsiteImpl("API", "api", "", "API server for some of my desktop applications. Root page will soon be documented so others can use my endpoints to extend or replace desktop clients.")
];